...
if (!projectId) {
  console.warn(
    '[Zeinyra] VITE_WALLETCONNECT_PROJECT_ID is not set. ' +
...
createAppKit({
  ...
  metadata: {
    ...
    url: typeof window !== 'undefined' ? window.location.origin : 'https://Zeinyra.vercel.app',
    icons: ['https://Zeinyra.vercel.app/favicon.ico'],
  },
  features: {
